...
![](https://github.com/bbccyy/NoteBook/blob/master/src/2023/12_1/11.png?raw=true)
...
![](https://github.com/bbccyy/NoteBook/blob/master/src/2023/12_1/12.png?raw=true)
...
![](https://github.com/bbccyy/NoteBook/blob/master/src/2023/12_1/13.png?raw=true)
...
![](https://github.com/bbccyy/NoteBook/blob/master/src/2023/12_1/14.png?raw=true)
...
![](https://github.com/bbccyy/NoteBook/blob/master/src/2023/12_1/15.png?raw=true)
...
![](https://github.com/bbccyy/NoteBook/blob/master/src/2023/12_1/16.png?raw=true)
...
![](https://github.com/bbccyy/NoteBook/blob/master/src/2023/12_1/17.png?raw=true)
...
![](https://github.com/bbccyy/NoteBook/blob/master/src/2023/12_1/18.png?raw=true)
...
![](https://github.com/bbccyy/NoteBook/blob/master/src/2023/12_1/19.png?raw=true)
...
3) 视硬件制造商不同，ConstantBuffer与StructuredBuffer相比可能会有更高的读写效率（因为数据被Alloc在更加接近计算核心的高速Cache上），因此其资源总量也是相对受限的，虽然不同的Gfx API对单个CB的尺寸有大小的限制，但是同一时刻大量运用CB从原理上将可能会很快耗尽硬件资源，导致数据截断，或者引起数据频繁换出换入。
...
![](https://github.com/bbccyy/NoteBook/blob/master/src/2023/12_1/20.png?raw=true)
...
![](https://github.com/bbccyy/NoteBook/blob/master/src/2023/12_1/21.png?raw=true)
...
![](https://github.com/bbccyy/NoteBook/blob/master/src/2023/12_1/22.png?raw=true)

下面一组对比图同样来自官方文档，主要从数据流角度出发，SRP Batch将不同更新频率的数据做了区分（Built-In和Per-Material），各自使用专职代码处理，数据位于GPU缓存的不同区域。

![](https://github.com/bbccyy/NoteBook/blob/master/src/2023/12_1/23.png?raw=true)
